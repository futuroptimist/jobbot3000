...
- Analytics exports retry temporarily locked output files (EBUSY/EPERM/EACCES) up to three times,
  printing a stderr prompt to close external editors before the next attempt; see
