...
Functional assertions run at the default desktop browser size and at a touch mobile viewport of `375×812`. The dedicated visual-review workflow captures human-review artifacts at `1440×900` and `375×812` in runner temp storage only. Playwright now covers both sides of the historical-update contract: ordinary historical navigation, scrubbing, and tab navigation do not show `Newer activity available`, while a supported application-form lifecycle mutation shows that notice once and keeps the selected historical snapshot anchored to its original cutoff.
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm ci`                                                                                                                                                                      | Pass locally                                                                                                                                                   |
| `npx prettier --check test/playwright/lifecycle-diagram.spec.js docs/design/application-lifecycle-diagram-validation.md`                                                      | Pass locally (`All matched files use Prettier code style!`)                                                                                                    |
| `npm run format:check` (full repository)                                                                                                                                      | Fails with 262 files; untouched `origin/main` also fails with 262 files; repository-wide repair tracked separately                                             |
| `npm run lint`                                                                                                                                                                | Pass locally                                                                                                                                                   |
| `npm run typecheck`                                                                                                                                                           | Pass locally                                                                                                                                                   |
| `npm run prepare:test`                                                                                                                                                        | Pass locally                                                                                                                                                   |
| `PLAYWRIGHT_BROWSERS_PATH=.cache/ms-playwright PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD=1 npx playwright test test/playwright/lifecycle-diagram.spec.js`                              | Pass locally                                                                                                                                                   |
| `PLAYWRIGHT_BROWSERS_PATH=.cache/ms-playwright PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD=1 npx playwright test test/playwright/lifecycle-diagram.spec.js --grep "announces genuinely"` | Pass locally for the P6-F1 positive historical-update regression                                                                                               |
| `npm run test:ci`                                                                                                                                                             | Fails locally in this workspace after the Vitest worker reports `Timeout calling "onTaskUpdate"`; the exercised tests reported passing before the worker error |
| `npm run build`                                                                                                                                                               | Pass locally                                                                                                                                                   |
| `git diff --check`                                                                                                                                                            | Pass locally                                                                                                                                                   |
| `BASE=$(git merge-base origin/main HEAD)`                                                                                                                                     | Pass locally with `BASE=3eb174cf9652c329baa688fa672ca453f7f695db`                                                                                              |
| Secret scan and binary audit commands                                                                                                                                         | Pass locally against `BASE=3eb174cf9652c329baa688fa672ca453f7f695db`                                                                                           |
