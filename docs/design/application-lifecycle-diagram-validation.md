...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `npm ci`                                                                                                                                                                              | Pass locally                                                                                                                                                                   |
| `npm run format:check`                                                                                                                                                                | Fails locally in 262 files on this branch; clean `origin/main` also fails in 263 files, so the remaining drift is a repository baseline issue rather than a P6-only regression |
...
- Current GitHub Actions evidence for the validated code head `211e86eeb4350fbe975da5ba27c321af44d1c3fd`: Diagram visual review run `29293379739`, CI run `29293379741`, and GHCR image build/smoke run `29293379746` all succeeded; artifact `diagram-visual-review-1130-1` contains four nonempty PNGs at the required sizes (`diagram-desktop-current.png` 1440×900, `diagram-desktop-history.png` 1440×900, `diagram-mobile-current.png` 375×812, `diagram-mobile-history.png` 375×812).
