...
- [docs/design/lifecycle-diagram-layout-algorithm.md](docs/design/lifecycle-diagram-layout-algorithm.md) – engineering internals of the lifecycle diagram's deterministic lane/handle-placement solver and documented remaining base-layout follow-ups
