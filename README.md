...
counts, drop-offs, and conversion percentages. Stages without a prior baseline report conversions
as `n/a` so gaps in tracking do not mislead. A dedicated unit test in
